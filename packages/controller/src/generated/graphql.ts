...
export type AcceptFriendRequestMutation = {
  __typename?: 'Mutation'
  acceptFriendRequest: { __typename?: 'User'; id: number; displayName: string }
}
...
export type DeclineFriendRequestMutation = {
  __typename?: 'Mutation'
  declineFriendRequest: { __typename?: 'User'; id: number; displayName: string }
}
...
export type SendFriendRequestMutation = {
  __typename?: 'Mutation'
  sendFriendRequest: { __typename?: 'User'; id: number; displayName: string }
}
...
export type FriendsQuery = {
  ...
  user?: {
    __typename?: 'User'
    friends: Array<{ __typename?: 'User'; id: number; displayName: string; status?: string | null }>
  } | null
}
...
export function useAcceptFriendRequestMutation() {
  return Urql.useMutation<AcceptFriendRequestMutation, AcceptFriendRequestMutationVariables>(
...
export function useDeclineFriendRequestMutation() {
  return Urql.useMutation<DeclineFriendRequestMutation, DeclineFriendRequestMutationVariables>(
...
export function useSendFriendRequestMutation() {
  return Urql.useMutation<SendFriendRequestMutation, SendFriendRequestMutationVariables>(
...
export function useFriendRequestsQuery(
  ...
  return Urql.useQuery<FriendRequestsQuery, FriendRequestsQueryVariables>({
...
export function useServersQuery(options?: Omit<Urql.UseQueryArgs<ServersQueryVariables>, 'query'>) {
  return Urql.useQuery<ServersQuery, ServersQueryVariables>({ query: ServersDocument, ...options })
}
