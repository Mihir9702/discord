// ** 1. check for "nameId" & check for "userId"
// ** 2. successfully sends the frq to other user
// ** 3. check current user for frq
// ** 4. log into other account and check for frq
// ** 5. accept frq on other account
// ** 6. check frs list for users
// ** 7. send msg from u to fr
// ** 8. render msg on fr
// ** 9. send msg from fr to u
// ** 10. log into u account and read fr msg
// ** 11. repeat steps with another account
